...
- YouTubeMusic_Resolve.yaml，请使用 behavior: "classical"。

#### 配置建议
- YouTubeMusic.yaml 单独使用。
- YouTubeMusic_Resolve.yaml 单独使用。
...
https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/YouTubeMusic/YouTubeMusic.yaml
...
https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Clash/YouTubeMusic/YouTubeMusic.yaml

**RELEASE分支 GHProxy (不定时更新)**

https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/YouTubeMusic/YouTubeMusic.yaml
