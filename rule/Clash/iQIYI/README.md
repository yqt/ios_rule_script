...
#### 使用说明
- iQIYI.yaml，请使用 behavior: "classical"。
- iQIYI_Resolve.yaml，请使用 behavior: "classical"。
...
https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Clash/iQIYI/iQIYI.yaml

**MASTER分支 GHProxy (每日更新)**

https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/iQIYI/iQIYI.yaml
...
https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Clash/iQIYI/iQIYI.yaml

**RELEASE分支 GHProxy (不定时更新)**

https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/iQIYI/iQIYI.yaml
