...
#### 使用说明
- Slack.yaml，请使用 behavior: "classical"。
- Slack_Resolve.yaml，请使用 behavior: "classical"。

#### 配置建议
- Slack.yaml 单独使用。
- Slack_Resolve.yaml 单独使用。
...
https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Slack/Slack.yaml
...
https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/Slack/Slack.yaml
