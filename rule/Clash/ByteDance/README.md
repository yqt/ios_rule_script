...
#### 使用说明
- ByteDance.yaml，请使用 behavior: "classical"。
- ByteDance_Resolve.yaml，请使用 behavior: "classical"。
...
https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Clash/ByteDance/ByteDance.yaml

**MASTER分支 GHProxy (每日更新)**

https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/ByteDance/ByteDance.yaml
...
https://cdn.jsdelivr.net/gh/blackmatrix7/ios_rule_script@release/rule/Clash/ByteDance/ByteDance.yaml

**RELEASE分支 GHProxy (不定时更新)**

https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/ByteDance/ByteDance.yaml
