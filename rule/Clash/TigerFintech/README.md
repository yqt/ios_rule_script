...
- TigerFintech_Resolve.yaml，请使用 behavior: "classical"。

#### 配置建议
- TigerFintech.yaml 单独使用。
- TigerFintech_Resolve.yaml 单独使用。
...
https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/TigerFintech/TigerFintech.yaml
...
https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/TigerFintech/TigerFintech.yaml
