...
- Python_Resolve.yaml，请使用 behavior: "classical"。

#### 配置建议
- Python.yaml 单独使用。
- Python_Resolve.yaml 单独使用。
...
https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Clash/Python/Python.yaml
...
https://ghproxy.com/https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/release/rule/Clash/Python/Python.yaml
